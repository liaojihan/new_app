...
class Details extends Component{
    ...
    componentDidMount() {
        console.log(this.props.url + this.props.match.params.id);
        fetchJsonp( this.state.url + this.props.match.params.id,
            {
                method: 'get',
                mode: 'cors',
                headers: {
                ...
                <div className="title">
                    <div className="area">
                        ...
                        <div className="movie-list">
                            <div className="movie-item">{ success ? message.title : ''}</div>
