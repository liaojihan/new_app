                                ...
                                <li>
                                    {
                                        li_list.map((value, index) => {
                                            return (
                                                <Link to={value[0]} onClick={(e) => this.handleStatus(0, e)}
                                                    className={this.props.appStore.refreshCode === index}>
                                                    {value[0]}
                                                </Link>
                                            )
                                        })
                                    }
                                    <Link to='/' onClick={(e) => this.handleStatus(0, e)}>
                                        首页
                                    </Link>
                                    <Link to={`/hot/${this.state.film_url}`}
                                        onClick={(e) => this.handleStatus(1, e)}>
                                        热映
                                    </Link>
                                    <Link to={}
                                        onClick={(e) => this.handleStatus(2, e)}>
                                        上映
                                    </Link>
